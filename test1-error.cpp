...
int  main(int argc, const char** argv) {
	...
	try {
		...
		/**
		 * @brief  I concatenate dataframes with different rows , it throws error handling message
		 * 
		 * @return DataFrame 
		 */
		DataFrame df2 (
			vector<string>{string("first row"),string("second row")},
			vector<string>{string("fifth col"),string("sixth col"),string("7th col")},
			vector<int>{3,6},
			vector<double>{10.5,1.55}
		);
